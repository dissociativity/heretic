        ...
        for layer_index in range(len(self.get_layers())):
            for component, modules in self.get_layer_modules(layer_index).items():
                ...
                for module in modules:
                    ...
                    if (
                        self.settings.compute_normalized
                        or self.settings.preserve_magnitudes
                    ):
                    ...
                    elif self.settings.compute_normalized:
                        # Apply the original magnitudes to LoRA component B.
                        lora_B = W_norm_row * lora_B
